  ...
  return (
    ...
    <div className="dark:bg-[#111010] w-full min-h-screen relative">
      ...
      <div className="p-3 font-bold mt-10 text-green-900 dark:text-red-600 text-6xl absolute" style={{ top: "28%", left: "12%", transform: "translate(-15%, -30%)" }}>
        ...
        <button onClick={scrollTo} className="mt-10 p-4 text-white bg-green-600 text-xl px-6 py-3 rounded-full hover:bg-blue-600 dark:bg-[#111010] dark:border-4 dark:hover:bg-blue-600 transition-transform hover:scale-1">
          Read Now
        </button>
      </div>
