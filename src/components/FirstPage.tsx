    ...
    <>
      <div className="dark:bg-[#111010] w-full min-h-screen relative">
        ...
        <div
          ...
          style={{ top: "28%", left: "12%", transform: "translate(-15%, -30%)" }}
        >
          <h1
          ...
          <div className="flex mt-10 space-x-4">
            <Link href="/pages">
              <button className="p-2 text-white bg-green-600 sm:text-xl text-sm px-4 py-3 sm:px-6 rounded-full hover:bg-blue-600 dark:bg-[#111010] dark:border-4 dark:hover:bg-blue-600 transition-transform hover:scale-105">
                Read Now
              </button>
            </Link>
            <Link href="/jobs">
