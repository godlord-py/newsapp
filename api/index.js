...
const sequelize = new Sequelize('news_db_r1km', 'news_db_r1km_user', '1B43R1ry6C4hjkFc0ZM6ETFaPmqsaYJw', {
  host: 'dpg-d7l6l7hj2pic73clbcfg-a.singapore-postgres.render.com',
  dialect: 'postgres',
  port: 5432, 
  dialectOptions: {
    ssl: {
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'", "http://localhost:5173", "http://127.0.0.1:5173", "https://6690f69e767262054b9e01c6--thriving-hotteok-03030a.netlify.app", "https://669a1b1b9dd1e0eb57104bf2--thriving-hotteok-03030a.netlify.app", 'https://newsjobshub.netlify.app'],
      scriptSrc: ["'self'", "http://localhost:5173", "http://127.0.0.1:5173", "'unsafe-inline'", "https://6690f69e767262054b9e01c6--thriving-hotteok-03030a.netlify.app", "https://669a1b1b9dd1e0eb57104bf2--thriving-hotteok-03030a.netlify.app", 'https://newsjobshub.netlify.app'],
      styleSrc: ["'self'", "http://localhost:5173", "http://127.0.0.1:5173", "'unsafe-inline'", "https://6690f69e767262054b9e01c6--thriving-hotteok-03030a.netlify.app", "https://669a1b1b9dd1e0eb57104bf2--thriving-hotteok-03030a.netlify.app", 'https://newsjobshub.netlify.app'],
      fontSrc: ["'self'", 'data:'],
      imgSrc: ["'self'", 'data:'],
      connectSrc: ["'self'", "http://localhost:5173", "http://127.0.0.1:5173", "https://6690f69e767262054b9e01c6--thriving-hotteok-03030a.netlify.app", "https://669a1b1b9dd1e0eb57104bf2--thriving-hotteok-03030a.netlify.app", 'https://newsjobshub.netlify.app'],
      mediaSrc: ["'self'"],
      frameSrc: ["'self'"]
    }
  }
